...
import CollectionsCarousel, { NewCollection, CarouselCollection } from '../CollectionsCarousel'
...
const ChooseCollection = ({
    ...
    const validateAndProceed = () => {
        if (!selectedCollection.name || !selectedCollection.collection_name) {
            setNoneSelectedError('Please select or create a collection before proceeding.')
        } else {
    ...
    return (
        <>
            ...
            <SubTitle>A small fee per NFT may be charged reflecting network costs.</SubTitle>
            ...
            />
            {noneSelectedError ? <ErrorMessage>{noneSelectedError}</ErrorMessage> : null}
