 ...
 * Creates signed deploy.
 */
const getSignedDeploy: SendDeployMethod = (rnodeHttp, now) => async (
  { httpUrl },
  account,
  code,
  phloLimit
 ...
 */
const sendDeploy: SendDeployMethod = (rnodeHttp, now) => async (
  { httpUrl },
  account,
  code,
  phloLimit
 ...
 */
const getDataForDeploy: DataForDeployMethod = (rnodeHttp) => async (
  { httpUrl },
  deployId,
  onProgress
) => {
 ...
 */
const fetchDeploy: FetchDeployMethod = (rnodeHttp) => async (
  { httpUrl },
  deployId
) => {
